...
typedef NS_ENUM(NSInteger, HWSegmentedControlType) {
      HWSegmentedControlTypeDefault       = 0,//默认
      HWSegmentedControlTypePolygon       = 1,//多边形
};
...
@property (nonatomic, assign) HWSegmentedControlType type;
